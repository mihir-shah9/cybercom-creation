...
<body>
    ...
    <div>
        <form action="" method="POST" class="regi">
            <h2 style="margin-left: 160px">Register</h2>
            <div>
            ...
            <div>
                ...
                <input type="text" name="user[first_name]" value="<?= getData('user', 'first_name') ?>" id="firstName">
            ...
            <div>
                ...
                <input type="text" name="user[last_name]" value="<?= getData('user', 'last_name') ?>" id="lastName">
