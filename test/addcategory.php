...
<body>
    ...
    <div class="container">
        <form action="" method="Post" enctype="multipart/form-data" class="regi">
            <div>
                <h2 style="margin-left: 120px;">Add New Category</h2>
            </div>
            <div>
                <label for="title">Title</label>
                <input type="text" name="category[title]" id="title" value="<?= getData('category', 'title') ?>">
            ...
            <div>
                ...
                <textarea name="category[content]" id="content" cols="30" rows="10"><?= getData('category', 'content') ?></textarea>
            ...
            <div>
                ...
                <input type="url" name="category[url]" id="url" value="<?= getData('category', 'url') ?>">
            ...
            <div>
                ...
                <input type="text" name="category[meta_title]" id="metatitle" value="<?= getData('category', 'meta_title') ?>">
